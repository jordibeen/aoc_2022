...
fn pt1(input: &String) -> () {
    ...
    input.lines().for_each(|line| {
        ...
        // If the first set of ID numbers fully contains the other, or the second set of
        // ID numbers fully contains the first, this line is counted a reconsideration pair
